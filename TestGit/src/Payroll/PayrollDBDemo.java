/* 1) The the inputs using inputdialoguebox.
2) Display the output using messagebox
3) Write your own exception classes to handle nevgative input values.


Output/Program (Payroll Dialog class):
